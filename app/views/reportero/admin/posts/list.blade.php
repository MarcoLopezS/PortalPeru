...
<section class="content-header">
    <!--section starts-->
    <h1>Entradas</h1>
    <a href="{{ route('reportero-ciudadano.posts.create') }}" class="btn btn-md btn-default">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="button-dropdown" data-buttons="dropdown">
                                        ...
                                        <ul>
                                            <li><a href="{{ route('reportero-ciudadano.post.photoslist', $item->id) }}">Galería de Fotos</a></li>
                                        </ul>
                                    </div>
                                </td>
                            </tr>
