        ...
        <div class="col-lg-12">
            ...
            <div class="panel panel-danger">
                <div class="panel-body border">
                    {{ Form::model($tag, ['route' => ['administrador.tags.update', $tag->id], 'method' => 'PUT', 'class' => 'form-horizontal form-bordered']) }}
                            ...
                            <div class="form-group">
                                <div class="col-md-12 text-right">
                                    ...
                                    <a href="{{ route('administrador.tags.index') }}" class="btn btn-responsive btn-default btn-md">Cancelar</a>
                                </div>
                            </div>
