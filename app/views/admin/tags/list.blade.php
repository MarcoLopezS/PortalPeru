...
<section class="content-header">
    <!--section starts-->
    <h1>Etiquetas</h1>
    <a href="{{ route('administrador.tags.create') }}" class="btn btn-md btn-default">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="button-dropdown" data-buttons="dropdown">
                                        ...
                                        <ul>
                                            <li><a href="{{ route('administrador.tags.show', $item->id) }}">Ver</a></li>
                                            <li><a href="{{ route('administrador.tags.edit', $item->id) }}">Editar</a></li>
                                            <li><a href="{{ route('administrador.tags.destroy', $item->id) }}">Eliminar</a></li>
                                        </ul>
                                    </div>
                                </td>
                            </tr>
