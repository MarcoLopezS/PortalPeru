            ...
            <div class="panel panel-info" style="overflow:auto;">
                ...
                <div class="panel-body" style="padding:0px !important;">
                    <div class="col-md-12" style="padding:30px; float:center;">
                        {{ Form::open(['route' => ['administrador.gallery.photosuploadsave', $galleries->id], 'method' => 'post', 'class' => 'dropzone']) }}
                        {{ Form::close() }}

                        <a href="{{ route('administrador.gallery.photoslist', $galleries->id) }}" class="btn btn-primary">Ver fotos</a>
                    </div>
                </div>
            </div>
        </div>
