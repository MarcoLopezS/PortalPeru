...
<section class="content-header">
    ...
    <a href="{{ route('administrador.gallery.create') }}" class="btn btn-md btn-default">
        ...
        <div class="col-lg-12">
            <div class="panel panel-primary filterable">
                <div class="panel-body">
                    ...
                    {{ Form::model(Input::all(), ['route' => 'administrador.gallery.index', 'method' => 'GET', 'class' => 'form-horizontal']) }}
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-2">
                                <a href="{{ route('administrador.gallery.index') }}" class="btn btn-danger">Borrar busqueda</a>
                            </div>
                        </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="button-dropdown" data-buttons="dropdown">
                                        ...
                                        <ul>
                                            <li><a href="{{ route('administrador.gallery.show', $item->id) }}">Ver</a></li>
                                            <li><a href="{{ route('administrador.gallery.edit', $item->id) }}">Editar</a></li>
                                            <li><a href="{{ route('administrador.gallery.destroy', $item->id) }}">Eliminar</a></li>
                                            <li><a href="{{ route('administrador.gallery.photoslist', $item->id) }}">Fotos</a></li>
                                        </ul>
                                    </div>
                                </td>
                            </tr>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-5 col-sm-12">
                            <div class="dataTables_info" id="table1_info" role="status" aria-live="polite">Total de registros: {{ $gallery->getTotal() }}</div>
                        </div>
...
{{ HTML::script('admin/js/posts/table-advanced.js') }}
