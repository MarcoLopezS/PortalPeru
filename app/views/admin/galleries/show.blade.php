                ...
                <div class="panel-body border">
                    ...
                    <div class="form-horizontal form-bordered">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                {{ Form::text('titulo', $gallery->titulo, ['class' => 'form-control', 'disabled']) }}
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                              ...
                              <div class="col-md-9">
                                    <a class="fancybox" href="/upload/{{ $gallery->imagen_carpeta."".$gallery->imagen }}" title="{{ $gallery->titulo }}">
                                          <img src="/upload/{{ $gallery->imagen_carpeta."200x150/".$gallery->imagen }}" alt="" width="200"/>
                                    </a>
                              </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="col-md-12 text-right">
                                <a href="{{ route('administrador.gallery.edit', $gallery->id) }}" class="btn btn-responsive btn-primary btn-md">Editar</a>
                                <a href="{{ route('administrador.gallery.index') }}" class="btn btn-responsive btn-default btn-md">Ver registros</a>
                            </div>
                        </div>
