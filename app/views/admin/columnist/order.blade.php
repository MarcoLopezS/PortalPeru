                            ...
                            <div class="tab-content">
                                <div class="tab-pane active gallery-padding">
                                    <div class="col-md-12">
                                        ...
                                        <ul id="listPhotos" data-url="{{ route('administrador.columnist.orderForm') }}">

                                            @foreach($photos as $item)

                                            <li id="listPhoto_{{ $item->id }}" class="col-lg-2 col-md-3 col-xs-6 col-sm-3 gallery-border">

                                                <img height="100" width="100" src="/upload/columnista/100x100/{{ $item->foto }}" class="gallery-style" alt="Image">
