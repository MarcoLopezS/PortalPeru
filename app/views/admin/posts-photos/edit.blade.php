		...
		<div class="col-lg-12">
			...
			<div class="panel panel-danger">
				<div class="panel-body border">
					...
					{{ Form::model($photo, ['route' => ['administrador.post.photosUpdate', $posts->id, $photo->id], 'method' => 'PUT', 'class' => 'form-horizontal form-bordered', 'files' => 'true']) }}
                        ...
                        <div class="form-group">
                            <div class="col-md-12 text-right">
                                ...
                                <a href="{{ route('administrador.post.photoslist', $posts->id) }}" class="btn btn-responsive btn-default btn-md">Cancelar</a>
                            </div>
                        </div>
